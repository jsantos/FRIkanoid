...
+ (void) resolveCollisionBetween:(id <IParticleColider>)particle1 and:(id <IParticleColider>)particle2 {
	...
	Vector2 *collisionNormal = collidedDistance ? [[Vector2 vectorWithVector:collisionDifference] normalize] : [Vector2 unitX];
